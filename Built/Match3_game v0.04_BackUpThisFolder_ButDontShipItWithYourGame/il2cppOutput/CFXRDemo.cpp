...
IL_0053:
	...
	}
	{
		...
		L_18 = List_1_ToArray_m9237E7439BAF0FDCFB325D21398E459BEDB3432C(L_17, List_1_ToArray_m9237E7439BAF0FDCFB325D21398E459BEDB3432C_RuntimeMethod_var);
		__this->___effectsList_27 = L_18;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___effectsList_27), (void*)L_18);
		// PlayAtIndex();
		CFXR_Demo_PlayAtIndex_m9015D10CB7D122067A50B951740F04A5B9BC1112(__this, NULL);
		// UpdateLabels();
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_Update_m9A55C3BA95AAE759CC901A345356ADCC54E71DCD (CFXR_Demo_tC798392D488F2E202DFEB3464B0A5EFEC019BE6C* __this, const RuntimeMethod* method) 
{
	...
	CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* V_9 = NULL;
	int32_t V_10 = 0;
	CFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A* V_11 = NULL;
	bool V_12 = false;
	bool V_13 = false;
	bool V_14 = false;
	bool V_15 = false;
	bool V_16 = false;
	Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00 V_17;
	...
	Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* G_B43_2 = NULL;
	{
		// if (rotateCamera)
		bool L_0 = __this->___rotateCamera_24;
		V_1 = L_0;
...
IL_002f:
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_12 = __this->___currentEffect_26;
		NullCheck(L_12);
...
IL_0073:
	{
		...
		NullCheck(L_17);
		bool L_18;
		L_18 = ParticleSystem_get_isEmitting_mE3EC701A8C5DACA27FDA91D8956CCE1ABAC6A0D9(L_17, NULL);
		V_6 = L_18;
		bool L_19 = V_6;
		if (!L_19)
		{
	...
	{
		// ps.Stop(true);
		ParticleSystem_tB19986EE308BD63D36FB6025EEEAFBEDB97C67C1* L_20 = V_4;
		NullCheck(L_20);
		ParticleSystem_Stop_m6CA855033D5CE2D3AF7927B6709BC65DBCD632DF(L_20, (bool)1, NULL);
		goto IL_00fa;
	}
...
IL_008d:
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_25 = __this->___currentEffect_26;
		NullCheck(L_25);
...
IL_00b8:
	{
		// ps.Play(true);
		ParticleSystem_tB19986EE308BD63D36FB6025EEEAFBEDB97C67C1* L_26 = V_4;
		NullCheck(L_26);
		ParticleSystem_Play_m4A59E0A2C7CA49EF75287A067305ABB314A16E62(L_26, (bool)1, NULL);
		// var cfxrEffects = currentEffect.GetComponentsInChildren<CFXR_Effect>();
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_27 = __this->___currentEffect_26;
		NullCheck(L_27);
		CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* L_28;
		L_28 = GameObject_GetComponentsInChildren_TisCFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A_m7298B4F90C049C78FED0FA41A2610C8268480135(L_27, GameObject_GetComponentsInChildren_TisCFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A_m7298B4F90C049C78FED0FA41A2610C8268480135_RuntimeMethod_var);
		V_8 = L_28;
		// foreach (var cfxr in cfxrEffects)
		CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* L_29 = V_8;
		V_9 = L_29;
		V_10 = 0;
		goto IL_00f0;
	}
...
IL_00d9:
	{
		// foreach (var cfxr in cfxrEffects)
		CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* L_30 = V_9;
		int32_t L_31 = V_10;
		NullCheck(L_30);
		int32_t L_32 = L_31;
		CFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A* L_33 = (L_30)->GetAt(static_cast<il2cpp_array_size_t>(L_32));
		V_11 = L_33;
		// cfxr.ResetState();
		CFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A* L_34 = V_11;
		NullCheck(L_34);
		CFXR_Effect_ResetState_m610E43E011438C9B8496202AC20150A8A296C1FF(L_34, NULL);
		int32_t L_35 = V_10;
...
IL_00f0:
	{
		// foreach (var cfxr in cfxrEffects)
		int32_t L_36 = V_10;
		CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* L_37 = V_9;
		NullCheck(L_37);
...
IL_00fc:
	{
		...
		bool L_38;
		L_38 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)127), NULL);
		if (L_38)
		{
			goto IL_010d;
		}
	...
	{
		bool L_39;
		L_39 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(8, NULL);
...
IL_010e:
	...
	{
		// if (currentEffect != null)
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_41 = __this->___currentEffect_26;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_42;
	...
	}
	{
		...
		// currentEffect.SetActive(true);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_45 = __this->___currentEffect_26;
		NullCheck(L_45);
...
IL_015d:
	{
		...
		bool L_48;
		L_48 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)275), NULL);
		V_15 = L_48;
		bool L_49 = V_15;
		if (!L_49)
		{
...
IL_0176:
	{
		...
		bool L_50;
		L_50 = Input_GetMouseButtonDown_m33522C56A54C402FE6DED802DD7E53435C27A5DE(0, NULL);
		V_16 = L_50;
		bool L_51 = V_16;
		if (!L_51)
		{
	...
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_52 = __this->___demoCamera_20;
		NullCheck(L_52);
		...
		L_54 = Input_get_mousePosition_m2414B43222ED0C5FAB960D393964189AFD21EEAD(NULL);
		NullCheck(L_53);
		...
		Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00 L_56 = V_17;
		bool L_57;
		L_57 = Physics_Raycast_m1461ED9FFA5B4E83AA5F89436124F5FCF4D0714D(L_56, NULL);
		V_18 = L_57;
		bool L_58 = V_18;
		if (!L_58)
		{
	...
	{
		// if (currentEffect != null)
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_59 = __this->___currentEffect_26;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_60;
	...
	{
		// currentEffect.SetActive(false);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_62 = __this->___currentEffect_26;
		NullCheck(L_62);
		GameObject_SetActive_m638E92E1E75E519E5B24CF150B08CA8E0CDFAB92(L_62, (bool)0, NULL);
		// currentEffect.SetActive(true);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_63 = __this->___currentEffect_26;
		NullCheck(L_63);
...
IL_01d8:
	{
		...
		bool L_64;
		L_64 = Input_GetMouseButtonDown_m33522C56A54C402FE6DED802DD7E53435C27A5DE(1, NULL);
		if (L_64)
		{
			goto IL_01e8;
		}
	...
	{
		bool L_65;
		L_65 = Input_GetMouseButtonDown_m33522C56A54C402FE6DED802DD7E53435C27A5DE(2, NULL);
		G_B37_0 = ((int32_t)(L_65));
		goto IL_01e9;
	}
...
IL_01f8:
	{
		...
		float L_67;
		L_67 = Input_GetAxis_m1F49B26F24032F45FB4583C95FB24E6771A161D4(_stringLiteralFC6687DC37346CD2569888E29764F727FAF530E0, NULL);
		V_0 = L_67;
		// if (scroll != 0f)
		float L_68 = V_0;
		V_21 = (bool)((((int32_t)((((float)L_68) == ((float)(0.0f)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_69 = V_21;
		if (!L_69)
		{
			goto IL_0245;
	...
	}
	{
		...
		L_72 = Vector3_get_forward_mEBAB24D77FC02FC88ED880738C3B1D47C758B3EB_inline(NULL);
		float L_73 = V_0;
		G_B41_0 = L_72;
		G_B41_1 = L_71;
...
IL_0238:
	{
		...
		L_74 = Vector3_op_Multiply_m516FE285F5342F922C6EB3FCB33197E9017FF484_inline(G_B43_1, G_B43_0, NULL);
		NullCheck(G_B43_2);
		Transform_Translate_m4A9E3D8836586E7562F6A18EBF5F5B6089D8B649(G_B43_2, L_74, 1, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_PlayAtIndex_m9015D10CB7D122067A50B951740F04A5B9BC1112 (CFXR_Demo_tC798392D488F2E202DFEB3464B0A5EFEC019BE6C* __this, const RuntimeMethod* method) 
{
	...
	{
		// currentEffect.SetActive(false);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_3 = __this->___currentEffect_26;
		NullCheck(L_3);
...
IL_0020:
	{
		...
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_4 = __this->___effectsList_27;
		int32_t L_5 = __this->___index_28;
		NullCheck(L_4);
		int32_t L_6 = L_5;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_7 = (L_4)->GetAt(static_cast<il2cpp_array_size_t>(L_6));
		__this->___currentEffect_26 = L_7;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___currentEffect_26), (void*)L_7);
		// currentEffect.SetActive(true);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_8 = __this->___currentEffect_26;
		NullCheck(L_8);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_WrapIndex_m82B44BE735AEBAE58FC762F9638EDCD5F86CD648 (CFXR_Demo_tC798392D488F2E202DFEB3464B0A5EFEC019BE6C* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (index < 0) index = effectsList.Length - 1;
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_2 = __this->___effectsList_27;
		NullCheck(L_2);
		__this->___index_28 = ((int32_t)il2cpp_codegen_subtract(((int32_t)(((RuntimeArray*)L_2)->max_length)), 1));
	}

IL_001e:
	{
		// if (index >= effectsList.Length) index = 0;
		int32_t L_3 = __this->___index_28;
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_4 = __this->___effectsList_27;
		NullCheck(L_4);
...
{
	{
		...
		__this->___slowMotion_23 = (bool)0;
		// bool rotateCamera = false;
		__this->___rotateCamera_24 = (bool)0;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_Translate_OnEnable_mC821E4225DE439D7668DEB5F1A32AA67933E5829 (CFXR_Demo_Translate_t95CB6CDBAE93F397B9CA608E9B233BAB8C7FB891* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		L_7 = Vector3_op_Multiply_m516FE285F5342F922C6EB3FCB33197E9017FF484_inline(L_6, (360.0f), NULL);
		float L_8;
		L_8 = Random_get_value_m87344B352E686178D743B14C468EEE01757E9D43(NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_9;
		L_9 = Vector3_Lerp_m57EE8D709A93B2B0FF8D499FA2947B1D61CB1FD6_inline(L_5, L_7, L_8, NULL);
		NullCheck(L_4);
