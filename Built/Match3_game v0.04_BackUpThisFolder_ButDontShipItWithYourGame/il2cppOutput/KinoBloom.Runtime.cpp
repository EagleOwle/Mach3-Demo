...
IL_0036:
	{
		...
		int32_t L_10 = V_2;
		float L_11;
		L_11 = Mathf_Log_m5AD7CD5F4DCE823F0D89CFFD817934769D73B2B7_inline(((float)L_10), (2.0f), NULL);
		...
		int32_t L_14 = V_5;
		int32_t L_15;
		L_15 = Mathf_Clamp_mA48718D9A20D8972EDD41714CEF6BBF864F442EA_inline(L_14, 1, ((int32_t)16), NULL);
		V_6 = L_15;
		...
		L_27 = Vector4_op_Implicit_mB05287DC52FC87A756AB80E837E1EC22FEEB3937_inline(L_26, NULL);
		NullCheck(L_25);
...
IL_00f1:
	{
		...
		L_40 = RenderTexture_GetTemporary_mEB21705B78CAF6B8F1F6617453A8EE8A94498DE2(L_37, L_38, 0, L_39, NULL);
		V_11 = L_40;
...
IL_0142:
	{
		...
		Graphics_Blit_m5A753341A113FB6501C64F73D62047F84F957E50(L_42, L_43, L_44, L_45, NULL);
...
IL_015e:
	{
		...
		L_54 = RenderTexture_GetTemporary_mEB21705B78CAF6B8F1F6617453A8EE8A94498DE2(((int32_t)(L_50/2)), ((int32_t)(L_52/2)), 0, L_53, NULL);
		NullCheck(L_47);
...
IL_0194:
	{
		...
		int32_t L_63 = V_12;
		il2cpp_codegen_runtime_class_init_inline(Graphics_t99CD970FFEA58171C70F54DF0C06D315BD452F2C_il2cpp_TypeInfo_var);
		Graphics_Blit_m5A753341A113FB6501C64F73D62047F84F957E50(L_57, L_61, L_62, L_63, NULL);
...
IL_01d5:
	{
		...
		L_86 = RenderTexture_GetTemporary_mEB21705B78CAF6B8F1F6617453A8EE8A94498DE2(L_82, L_84, 0, L_85, NULL);
		NullCheck(L_79);
...
IL_021e:
	{
		...
		int32_t L_94 = V_12;
		il2cpp_codegen_runtime_class_init_inline(Graphics_t99CD970FFEA58171C70F54DF0C06D315BD452F2C_il2cpp_TypeInfo_var);
		Graphics_Blit_m5A753341A113FB6501C64F73D62047F84F957E50(L_88, L_92, L_93, L_94, NULL);
...
IL_027a:
	{
		...
		int32_t L_108 = V_12;
		il2cpp_codegen_runtime_class_init_inline(Graphics_t99CD970FFEA58171C70F54DF0C06D315BD452F2C_il2cpp_TypeInfo_var);
		Graphics_Blit_m5A753341A113FB6501C64F73D62047F84F957E50(L_105, L_106, L_107, L_108, NULL);
...
IL_0292:
	...
	}
	{
		...
		RenderTexture_ReleaseTemporary_m7D9B385460ED0D0CF7BCC033605CEBD60A1A232F(L_118, NULL);
	}
...
IL_02b7:
	...
	}
	{
		...
		RenderTexture_ReleaseTemporary_m7D9B385460ED0D0CF7BCC033605CEBD60A1A232F(L_128, NULL);
	}
...
IL_02f6:
	...
	}
	{
		...
		RenderTexture_ReleaseTemporary_m7D9B385460ED0D0CF7BCC033605CEBD60A1A232F(L_136, NULL);
		// }
		return;
	}
}
